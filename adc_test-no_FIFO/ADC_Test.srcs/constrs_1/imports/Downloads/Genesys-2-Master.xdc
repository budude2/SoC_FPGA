...
set_property -dict {PACKAGE_PIN F22 IOSTANDARD LVCMOS18} [get_ports CSB1]
set_property -dict {PACKAGE_PIN G22 IOSTANDARD LVCMOS18} [get_ports CSB2]
set_property -dict {PACKAGE_PIN L18 IOSTANDARD LVCMOS18} [get_ports SCLK]
set_property -dict {PACKAGE_PIN L17 IOSTANDARD LVCMOS18} [get_ports SDIO]
